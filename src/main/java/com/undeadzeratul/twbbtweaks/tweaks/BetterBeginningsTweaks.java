...
public class BetterBeginningsTweaks
{
    ...
    private static void nerfChainArmor ()
    {
        ...
        nerfArmorRecipe(new ItemStack(GameRegistry.findItem(ModIds.MINECRAFT, "chainmail_helmet")), mainCost, StringUtils.EMPTY);
        nerfArmorRecipe(new ItemStack(GameRegistry.findItem(ModIds.MINECRAFT, "chainmail_chestplate")), mainCost, StringUtils.EMPTY);
        nerfArmorRecipe(new ItemStack(GameRegistry.findItem(ModIds.MINECRAFT, "chainmail_leggings")), mainCost, StringUtils.EMPTY);
        nerfArmorRecipe(new ItemStack(GameRegistry.findItem(ModIds.MINECRAFT, "chainmail_boots")), mainCost, StringUtils.EMPTY);
    }
    ...
    private static void nerfTwilightforestArmor ()
    {
        ...
        nerfArmorRecipe(GameRegistry.makeItemStack(ModIds.TWILIGHT_FOREST + ':' + "item.ironwoodHelm", 0, 1,
                                                   "{ench: [{lvl: 1, id: 6}]}"),
                        ironwoodIngot, StringUtils.EMPTY);
